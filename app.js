...
function addTodo(e) {
  //   console.log(e.type); type of event that happened
  ...
  if (todoInput.value.trim() !== "") {
    ...
    todoDiv.appendChild(newTodo); // to add a child inside the parent container.

    // Create a button to mark the task as completed
    const completeButton = document.createElement("button");
    completeButton.classList.add("complete-btn");
    completeButton.innerHTML = `<i class="fa-solid fa-check"></i>`; // add a new element in an element
